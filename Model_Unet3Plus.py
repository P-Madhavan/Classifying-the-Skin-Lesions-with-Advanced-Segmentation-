...
# Define the U-Net3+ model
def create_unet3plus_model(input_shape):
    # Encoder
...
def Model_Unet3Plus(train_images, train_masks, test_images, test_masks, Images):
    # Specify the input shape
    input_shape = (224, 224, 3)  # Adjust according to your input size

    # Create the U-Net3+ model
    model = create_unet3plus_model(input_shape)
